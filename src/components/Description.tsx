...
const Description = ({ activeImage, clickNext, clickPrev }: Props) => {
  return (
    <div className="grid place-items-start w-full bg-[#e7dfd9] relative md:rounded-tr-3xl md:rounded-br-3xl">
      <div className="uppercase text-sm absolute left-4 top-2 underline-offset-4 underline">
        Our Events
      </div>
      {images.map((elem, idx) => (
        <div
        ...
        >
          <motion.div
            ...
            className="w-full"
          >
            <div className="py-10 text-3xl font-extrabold">{elem.title}</div>
          ...
          <div className=" my-20">
                <Link href="/">
          <button className="bg-[#ecae7e] text-white uppercase px-4 py-2 rounded-md my-10 hover:bg-slate-400 ">
            Book Now
          </button>
            </Link>
          </div>
