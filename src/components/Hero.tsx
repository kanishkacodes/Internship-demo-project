...
function Hero() {
  const images = [
    ...
    "https://images.unsplash.com/photo-1516813127689-b75da14cce70?q=80&w=1798&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
  ];

  return (
    <div className="static bg-black ">
      <ImagesSlider className="md:h-[50rem] h-screen" images={images}>
        <motion.div
          initial={{
            opacity: 0,
            y: -80,
